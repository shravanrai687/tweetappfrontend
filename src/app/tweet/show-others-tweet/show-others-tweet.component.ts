...
@Component({
  selector: 'app-show-others-tweet',
  templateUrl: './show-others-tweet.component.html',
  styleUrls: ['./show-others-tweet.component.css']
})
export class ShowOthersTweetComponent implements OnInit {
...
search()
{
  let user = new Login(this.searchId,"dummy");
